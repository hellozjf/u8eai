 ...
 * generated in the com.hellozjf.test.u8eai.domain.jaxb.Consignment package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.hellozjf.test.u8eai.domain.jaxb.Consignment
     * 
     */
